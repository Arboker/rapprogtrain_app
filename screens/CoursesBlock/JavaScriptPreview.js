...
import JavaScriptPlan from './JavaScriptPlan'
import { light, dark } from '../../assets/theme'

class JavaScriptPreview extends Component {
  ...
  render() {
    return (
      ...
      <ScrollView style={{backgroundColor: this.state.theme=="dark" ? "#212121" : "white"}}>
          ...
          <Text
          onPress={() =>
        this.props.navigation.navigate('JavaScriptPlan')
          }
          ...
          <Text style={{color:'white', marginRight:20}}>27 урока</Text>
          ...
          fontFamily: 'Roboto-M',  fontWeight:'700', fontSize: 15}}>Зачем изучать JavaScript?</Text>
                </View>

                <View style={{paddingTop:10}}>
                <Text style={{color: this.state.theme=="dark" ? dark.colors.color : light.colors.color,
                fontFamily: 'OpenSans-R', fontSize: 15}}>
    JavaScript является одним из самых мощных и гибких языков программирования в Интернете.
     Он управляет динамическим поведением на большинстве веб-сайтов.</Text>
                </View>
                ...
                Вы изучите основы программирования используя последний синтаксис JavaScript.
                 Концепции, охватываемые этими уроками, лежат в основе использования JavaScript в любой среде.
                      </Text>
                      ...
                      fontFamily: 'Roboto-M',  fontWeight:'700', fontSize: 15}}>Требования</Text>
                            ...
                            <Text style={{color: this.state.theme=="dark" ? dark.colors.color : light.colors.color,
                            fontFamily: 'OpenSans-R', fontSize: 15}}>
                            Перед началом изучения этого курса вам нужно знать основы HTML и CSS.
                            </Text>
                            </View>
