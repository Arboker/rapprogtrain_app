...
class ReactPreview extends Component {
  ...
  render() {
    return (
      ...
      <ScrollView style={{backgroundColor: this.state.theme=="dark" ? "#212121" : "white"}}>
          ...
          <Text
          onPress={() =>
        this.props.navigation.navigate('ReactPlan')
          }
          ...
          fontFamily: 'Roboto-M',}} />
          <Text style={{color: this.state.theme=="dark" ? dark.colors.color : light.colors.color,
          fontFamily: 'Roboto-M',  fontWeight:'700', fontSize: 15}}>Зачем изучать React?</Text>
                </View>

                <View style={{paddingTop:10}}>
                <Text style={{color: this.state.theme=="dark" ? dark.colors.color : light.colors.color,
                fontFamily: 'OpenSans-R', fontSize: 15}}>
React представляет из себя изящные решения некоторых из наиболее постоянных проблем веб-программирования.
Это масштабируемый, быстрый, гибкий и мощный фреймворк.</Text>
                </View>
                ...
                fontFamily: 'Roboto-M',  fontWeight:'700', fontSize: 15}}>Получишь навыки:</Text>
                      ...
                      <Text style={{color: this.state.theme=="dark" ? dark.colors.color : light.colors.color,
                      fontFamily: 'OpenSans-R', fontSize: 15}}>
          Вы получите глубокое понимание наиболее важных концепций React: JSX, компоненты, контекст, методы жизненного цикла и т.д.
          Вы сможете объединить эти идеи в модульном стиле программирования React.
                      </Text>
